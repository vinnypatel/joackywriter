...
- (void)setRecordingToBeSentAgainFromAudioAtURL:(NSURL *)audioURL {
   ...
   NSURL *url =  [self copyTemporaryAudioFileToPersistentLocation: audioURL];
    [self.recordingDelegate audioManager:self didFinishRecordingSuccessfully:YES recodingURL:url];
}
...
- (void)audioRecorderDidFinishRecording:(AVAudioRecorder *)avrecorder successfully:(BOOL)flag {
    ...
    if([self hasCapturedSufficientAudioLength]) {
        url = [self copyTemporaryAudioFileToPersistentLocation:[self temporaryRecordedAudioFileURL]];
    }

    [self.recordingDelegate audioManager:self didFinishRecordingSuccessfully:flag recodingURL:url];
}
...
- (NSURL *)copyTemporaryAudioFileToPersistentLocation:(NSURL *)audioURL {
    ...
    return  [self recordedAudioFileURL];
